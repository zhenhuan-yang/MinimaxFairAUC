...
def main():
    ...
    filefile_path = os.path.join(file_path, args.db_name)
    if not os.path.exists(filefile_path):
        os.makedirs(filefile_path)

    plotter = Plotter(fig_path=filefile_path, show=False)
